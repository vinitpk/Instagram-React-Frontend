...
// Define the CommentModal component with props
const CommentModal = ({
    isOpen,
    onClose,
    onOpen,
    ...
    // Call API to fetch post by ID when postId or comments changes
    useEffect(() => {
        dispatch(
            findPostByIdAction({
                jwt,
    ...
    // Handle input change for adding a comment
    const handleCommnetInputChange = (e) => {
        setCommentContent(e.target.value);
    };

    // Handle Enter key press when adding a comment
    ...
    // Render the CommentModal component with all its UI elements
    return (
        <div>
...
// Export the CommentModal component
